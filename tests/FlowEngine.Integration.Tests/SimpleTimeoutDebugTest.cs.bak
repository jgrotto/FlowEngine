...
public class SimpleTimeoutDebugTest : IDisposable
{
    private readonly ITestOutputHelper _output;
    private readonly FlowEngineCoordinator _coordinator;

    public SimpleTimeoutDebugTest(ITestOutputHelper output)
    {
        _output = output;
    ...
    [Fact]
    public async Task SimpleSourceToSink_ShouldWork()
    {
        var yamlConfig = @"
pipeline:
  name: ""Simple Debug Pipeline""
  version: ""1.0.0""
...
";
        ...
        _output.WriteLine("Starting simple source->sink test...");
        ...
        {
            _output.WriteLine("Pipeline timed out - debugging needed");
